                                ...
                                <label className={`dropzone ${resumeFileName ? 'dropzone--filled' : ''}`} htmlFor='resume'>
                                    {resumeFileName ? (
                                        <>
                                            ...
                                            <p className='dropzone__subtitle'>Uploaded — click to replace</p>
                                        </>
                                    ) : (
                                        <>
            ...
            <section className='recent-reports'>
                ...
                {reports.map(report => (
                    <li key={report._id} className='report-item' onClick={() => navigate(`/interview/${report._id}`)}>
                        ...
                        onClick={(e) => {
                            e.stopPropagation()
                            if (window.confirm("Delete this interview plan? This can't be undone.")) {
                                deleteReport(report._id)
                            }
                        }}
                        aria-label='Delete report'
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6" /><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></svg>
                    </button>
